...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python scripts/collect_training_data.py                        # All sources
  python scripts/collect_training_data.py --dry-run              # No writes
  python scripts/collect_training_data.py --source wikipedia     # Wikipedia only
  python scripts/collect_training_data.py --source arxiv --report
  python scripts/collect_training_data.py --batch 5000           # 5k Wikipedia articles
        """,
    )
