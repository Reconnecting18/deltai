...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python scripts/daily_training.py               # Full cycle
  python scripts/daily_training.py --dry-run     # Dry run (no actual training)
  python scripts/daily_training.py --day 0       # Force Monday curriculum
  python scripts/daily_training.py --no-train    # Distillation only, skip QLoRA
  python scripts/daily_training.py --report-only # Show last report
        """,
    )
